...
def gff3_genes(bioseq,source="BioRuby",type="CTTCTT_exon",score=".",phase=".")
  ...
  File.open('genes_report.gff3', 'w+') do |i|
    ...
    @bioseq.each do |gene_id,bio_seq|
      ...
      bio_seq.features.each do |feature|
        ...
        attributes="ID=#{gene_id}_#{counts};" # add a different attribute for each feature
...
def gff3_chromosomes(bioseq,source="BioRuby",type="CTTCTT_chromosome",score=".",phase=".")
   ...
   j.puts("##gff-version 3")
    ...
    @bioseq.each do |gene_id,bio_seq|
      ...
      bio_seq.features.each do |feature|
        ...
        attributes="ID=#{gene_id}_#{counts};"
